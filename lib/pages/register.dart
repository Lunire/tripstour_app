...
import 'package:tripstour_app/model/request/customer_register_post_request.dart';
import 'package:tripstour_app/model/response/customer_register_post_res.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void register() {
    if (passwordCtl.text == confirmPasswordCtl.text) {
      ...
      http
          .post(
            Uri.parse("http://192.168.1.15:3000/customers"),
